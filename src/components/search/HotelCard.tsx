  ...
  return (
    <div className="bg-white flex flex-col rounded-[14px] w-full md:w-auto md:max-w-[397px]">
      <div className="md:min-w-[397px] w-full md:w-auto md:max-w-[397px] min-h-[265px] max-h-[265px] rounded-[14px] overflow-hidden relative">
        ...
        <div className="absolute inset-0 bg-card-overlay shadow-[inset_0px_-68px_76px_0px_#0080FF59] rounded-[14px]"></div>

        <span className="absolute bottom-3.5 left-[11px] text-white font-semibold text-[27px] leading-[1.625rem]">
